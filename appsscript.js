// This file can be added to the Google Sheet to auto-generate desired formatting.
// - Extensions > Apps script
// - Set this VERSION variable appropriately
// - Run the "setup" function
const VERSION = 1;

const L = 4 * VERSION + 17;
const NUM_CODEWORDS = {1: 19, 2: 34, 3: 55, 4: 80, 5: 108, 6: 136, 7: 156, 8: 194, 9: 232, 10: 274, 11: 324, 12: 370, 13: 428, 14: 461, 15: 523, 16: 569, 17: 647, 18: 721, 19: 795, 20: 861, 21: 932, 22: 1006, 23: 1094, 24: 1174, 25: 1276, 26: 1370, 27: 1468, 28: 1531, 29: 1631, 30: 1735, 31: 1843, 32: 1955, 33: 2071, 34: 2191, 35: 2306, 36: 2434, 37: 2566, 38: 2702, 39: 2812, 40: 2956};

const GRAY_COLOR = "#999999";
const RAINBOW_COLORS = ["#e6b8af", "#f4cccc", "#fce5cd", "#fff2cc", "#d9ead3", "#d0e0e3", "#c9daf8", "#cfe2f3", "#d9d2e9", "#ead1dc"];

function setup() {
  const sheet = SpreadsheetApp.getActiveSpreadsheet().getActiveSheet();

  const numRows = sheet.getMaxRows();
  const expectedNumRows = NUM_CODEWORDS[VERSION] + L + 14;
  ...
  sheet.setRowHeightsForced(L + 4, 1, 84); // row with longer descriptions
  sheet.setColumnWidths(1, expectedNumColumns, 21);

  sheet.getRange(3, 1, L, L).setDataValidation(SpreadsheetApp.newDataValidation()
